...
// HandlerDesconectarContrato processa uma mensagem de desconexao de contrato
// recebida da fila RabbitMQ. Conecta no POP e desconecta o usuario PPPoE.
func HandlerDesconectarContrato(body []byte) error {
	...
	var msg entity.MensagemDesconexaoContrato
